 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(O,I){var P=O.length;O.push(I);e:for(;0<P;){var Q=P-1>>>1,q=O[Q];if(0<i(q,I))O[Q]=I,O[P]=q,P=Q;else break e}}function t(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var I=O[0],P=O.pop();if(P!==I){O[0]=P;e:for(var Q=0,q=O.length,_n=q>>>1;Q<_n;){var Te=2*(Q+1)-1,Bn=O[Te],Dn=Te+1,dr=O[Dn];if(0>i(Bn,P))Dn<q&&0>i(dr,Bn)?(O[Q]=dr,O[Dn]=P,Q=Dn):(O[Q]=Bn,O[Te]=P,Q=Te);else if(Dn<q&&0>i(dr,P))O[Q]=dr,O[Dn]=P,Q=Dn;else break e}}return I}function i(O,I){var P=O.sortIndex-I.sortIndex;return P!==0?P:O.id-I.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var l=Date,u=l.now();e.unstable_now=function(){return l.now()-u}}var s=[],f=[],g=1,m=null,h=3,v=!1,w=!1,p=!1,E=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,a=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function d(O){for(var I=t(f);I!==null;){if(I.callback===null)r(f);else if(I.startTime<=O)r(f),I.sortIndex=I.expirationTime,n(s,I);else break;I=t(f)}}function y(O){if(p=!1,d(O),!w)if(t(s)!==null)w=!0,D(S);else{var I=t(f);I!==null&&ln(y,I.startTime-O)}}function S(O,I){w=!1,p&&(p=!1,c(x),x=-1),v=!0;var P=h;try{for(d(I),m=t(s);m!==null&&(!(m.expirationTime>I)||O&&!j());){var Q=m.callback;if(typeof Q=="function"){m.callback=null,h=m.priorityLevel;var q=Q(m.expirationTime<=I);I=e.unstable_now(),typeof q=="function"?m.callback=q:m===t(s)&&r(s),d(I)}else r(s);m=t(s)}if(m!==null)var _n=!0;else{var Te=t(f);Te!==null&&ln(y,Te.startTime-I),_n=!1}return _n}finally{m=null,h=P,v=!1}}var T=!1,C=null,x=-1,R=5,N=-1;function j(){return!(e.unstable_now()-N<R)}function ge(){if(C!==null){var O=e.unstable_now();N=O;var I=!0;try{I=C(!0,O)}finally{I?ne():(T=!1,C=null)}}else T=!1}var ne;if(typeof a=="function")ne=function(){a(ge)};else if(typeof MessageChannel<"u"){var We=new MessageChannel,U=We.port2;We.port1.onmessage=ge,ne=function(){U.postMessage(null)}}else ne=function(){E(ge,0)};function D(O){C=O,T||(T=!0,ne())}function ln(O,I){x=E(function(){O(e.unstable_now())},I)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(O){O.callback=null},e.unstable_continueExecution=function(){w||v||(w=!0,D(S))},e.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<O?Math.floor(1e3/O):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return t(s)},e.unstable_next=function(O){switch(h){case 1:case 2:case 3:var I=3;break;default:I=h}var P=h;h=I;try{return O()}finally{h=P}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(O,I){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var P=h;h=O;try{return I()}finally{h=P}},e.unstable_scheduleCallback=function(O,I,P){var Q=e.unstable_now();switch(typeof P=="object"&&P!==null?(P=P.delay,P=typeof P=="number"&&0<P?Q+P:Q):P=Q,O){case 1:var q=-1;break;case 2:q=250;break;case 5:q=1073741823;break;case 4:q=1e4;break;default:q=5e3}return q=P+q,O={id:g++,callback:I,priorityLevel:O,startTime:P,expirationTime:q,sortIndex:-1},P>Q?(O.sortIndex=P,n(f,O),t(s)===null&&O===t(f)&&(p?(c(x),x=-1):p=!0,ln(y,P-Q))):(O.sortIndex=q,n(s,O),w||v||(w=!0,D(S))),O},e.unstable_shouldYield=j,e.unstable_wrapCallback=function(O){var I=h;return function(){var P=h;h=I;try{return O.apply(this,arguments)}finally{h=P}}}})(bs);Js.exports=bs;var jf=Js.exports;/**
 * @license React
...
2022年10月12日，意大利女宇航员萨曼塔·克里斯托福雷蒂于国际空间站从距离地球420公里的高空，以每小时28000公里的速度飞越北京市上空时，在自己的Twitter账号上引用了本文中的“仰观宇宙之大，俯察品类之盛。所以游目骋怀，足以极视听之娱，信可乐也。”一句来表达自己俯瞰寰宇时飞扬的心绪，瞬间在中国社交平台引发广泛热议。[10]
`;function jp(){return F.jsxs("div",{className:"p-10",children:[F.jsx("h1",{className:"font-bold",children:"Text Range Selection"}),F.jsx("hr",{className:"my-2"}),F.jsx(zp,{text:Mp})]})}Jc(document.getElementById("root")).render(F.jsx(jp,{}));
